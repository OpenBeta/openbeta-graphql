...
Given the 10 climb types, 6 styles, and 7 attempt types, there are `10*6*7=` **420** diffent ways to "tick" a route. _(Thats not even accounting for the fact that a route can be multiple disciplines, eg: boulder & TR, or sport & deepwatersolo. If you really want to get nerdy: with the `2^10=1024` possible discipline combinations, there are a whopping `1024*6*7=` **43,008** ways to tick a route!)_
