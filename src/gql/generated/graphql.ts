...
export type ResolversUnionTypes<_RefType extends Record<string, unknown>> =
  ResolversObject<{
    Document:
      | (AreaPrimitive)
      | (Omit<Climb, 'parent' | 'ticks'> & {
        parent: _RefType['Area'];
        ticks?: Maybe<Array<Maybe<_RefType['TickType']>>>;
      })
      | (Organization);
  }>;
...
export type ResolversTypes = ResolversObject<{
  ...
  >;
  Climb: ResolverTypeWrapper<
    Omit<Climb, 'parent' | 'ticks'> & {
      parent: ResolversTypes['Area'];
      ticks?: Maybe<Array<Maybe<ResolversTypes['TickType']>>>;
    }
  >;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  Climb: Omit<Climb, 'parent' | 'ticks'> & {
    parent: ResolversParentTypes['Area'];
    ticks?: Maybe<Array<Maybe<ResolversParentTypes['TickType']>>>;
  };
