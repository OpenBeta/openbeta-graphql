...
import { CommonResolvers, CommonTypeDef } from './common/index'
import { HistoryQueries, HistoryFieldResolvers } from '../graphql/history/index'
import { QueryByIdType, GQLFilter, Sort, Context } from '../types'
import { AreaType, CountByDisciplineType } from '../db/AreaTypes'
import { ClimbGQLQueryType, ClimbType } from '../db/ClimbTypes'
import AreaDataSource from '../model/AreaDataSource'
import { MediaMutations, MediaQueries, MediaResolvers } from './media/index'
import { PostMutations, PostQueries, PostResolvers } from './posts/index'
import { XMediaMutations, XMediaQueries, XMediaResolvers } from './xmedia/index'
import { AreaQueries, AreaMutations } from './area/index'
import { ClimbMutations } from './climb/index'
import { OrganizationMutations, OrganizationQueries } from './organization/index'
import { TickMutations, TickQueries } from './tick/index'
import { UserQueries, UserMutations, UserResolvers } from './user/index'
import { getAuthorMetadataFromBaseNode } from '../db/utils/index'
